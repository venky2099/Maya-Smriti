...
**Finding:** Condition C ≈ Condition A — Maya mechanisms alone cannot overcome CIL output-head interference (Ahamkara) without episodic memory. Full Maya-Smriti outperforms replay-only by +0.77% AA and +1.02% BWT.
